...
## Logical Commits
1. `feat(scope): implement data model [XAN-{number}]`
2. `feat(scope): add API endpoint [XAN-{number}]`
3. `feat(scope): create UI component [XAN-{number}]`
4. `test(scope): add unit tests [XAN-{number}]`
```
...
| ------------ | --------------------------------------------------------- |
| Impl specs   | `specs/SPEC-XAN-{number}-{description}.md`  |
| Requirements | `docs/agent-outputs/requirements/XAN-*.md`  |
...
**Spec**: specs/SPEC-XAN-{number}-{description}.md
